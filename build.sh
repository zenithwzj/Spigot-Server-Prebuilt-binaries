...
echo '[build] Downloading openjdk-21.0.2 archive ...'
curl -L https://download.java.net/java/GA/jdk17.0.2/dfd4a8d0985749f896bed50d7138ee7f/8/GPL/openjdk-17.0.2_linux-x64_bin.tar.gz --output openjdk-17.0.2.tar.gz
if ! [ -e openjdk-17.0.2.tar.gz ] ;then
    >&2 echo '[build] Failed to download openjdk-21.0.2.tar.gz! The script is going to exit...'
    exit
fi
tar -zxf openjdk-17.0.2.tar.gz
...
../jdk-17.0.2/bin/java -jar BuildTools.jar --rev 1.19.1
