@echo off
@REM Partly copied from my private repository
...
..\jdk-21.0.2\bin\java -jar BuildTools.jar --rev 1.20.4 
if not exist spigot-1.20.4.jar (
...
move /Y SPBuild\spigot-1.20.4.jar .\ >nul
echo [build.bat] Removing src ...
rd /S /Q SPBuild

@REM artifact:spigot-1.20.4.jar
